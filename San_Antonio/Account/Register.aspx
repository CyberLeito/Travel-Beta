<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Travel_Beta.Account.Register" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <p class="text-danger">
        ...
        <asp:Image ID="Image1" class="AboutImg3" runat="server" ImageUrl="~/Content/pic1.jpg" />
    ...
    <div class="form-horizontal">
        <h4>Signup for a new San-Antonio Account</h4>
        <hr />
