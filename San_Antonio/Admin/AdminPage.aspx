...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-sm-4" style="z-index: 10";>
        <asp:Button ID="FeedbackRedir" runat="server" Text="Customer Feedback" CssClass="btn btn-default" OnClick="GoToFeedback" CausesValidation="false"/>
                <asp:Button ID="Button2" runat="server" Text="Remove Users" CssClass="btn btn-default" OnClick="GoToManageUser" CausesValidation="false"/>
    ...
    <br />
        <br />
          <br />
        <br />     
        <h4>Generate Order Reports</h4>
        <br />
     <asp:DropDownList id="DropDownList1" CssClass="form-control" style="max-width: 280px;" runat="server">
         <asp:ListItem  Value="Monthly">This month</asp:ListItem>
         <asp:ListItem Value="Annual">This Year</asp:ListItem>
         <asp:ListItem Value="Entire">Entire Record</asp:ListItem>
      </asp:DropDownList>
        <br />
        <div class="col-md-offset-2 col-md-10">
    <asp:Button ID="Button1" runat="server" Text="Generate Order Report"  CssClass="btn btn-primary" OnClick="GenerateReportOrders"  CausesValidation="false"/>
    </div>
    ...
    <asp:Button ID="AddProductButton" runat="server" Text="Add Product" CssClass="btn btn-primary" OnClick="AddProductButton_Click"  CausesValidation="true"/>
         ...
         <asp:Label ID="LabelDefaultConnectionStatus" runat="server" Text=""></asp:Label>
    <p></p>
    <br />
    <br />
    <br />
