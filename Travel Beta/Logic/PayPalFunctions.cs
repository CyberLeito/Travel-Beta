...
public class NVPAPICaller
{
    ...
    public string APIUsername = "munawwar_mi-facilitator_api1.hotmail.com";
    private string APIPassword = "<7NTKFR4ARN2UJDQZ>";
    private string APISignature = "<AFcWxV21C7fd0v3bYYYRCpSSRl31ACxqsFv4rqIsB71K4COrFUdVdBal>";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        encoder["BRANDNAME"] = "San Antonio Shoes Online";
